...
namespace McWendellKingSchedule.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Employee_UserName1", x => x.UserName1);
                });
            migrationBuilder.CreateTable(
                name: "Position",
                columns: table => new
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Position", x => x.PositionName);
                });
            migrationBuilder.CreateTable(
                name: "Shift",
                columns: table => new
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Shift", x => x.ShiftName);
                });
            migrationBuilder.CreateTable(
                name: "Schedule",
                columns: table => new
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ScheduleDetail_Employee_EmployeeID",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropForeignKey(name: "FK_IdentityUserRole<string>_IdentityRole_RoleId", table: "AspNetUserRoles");
            migrationBuilder.DropForeignKey(name: "FK_IdentityUserRole<string>_ApplicationUser_UserId", table: "AspNetUserRoles");
            migrationBuilder.DropTable("ScheduleDetail");
            migrationBuilder.DropTable("Position");
            migrationBuilder.DropTable("Schedule");
            migrationBuilder.DropTable("Shift");
